...
def main() -> None:
    ...
    application.add_handler(CommandHandler(["snatch"], guess, block=False))
...
if __name__ == "__main__":
    Grabberu.start()
    LOGGER.info("𝙎𝙣𝙖𝙩𝙘𝙝𝙚𝙧 𝘽𝙤𝙩 𝙨𝙩𝙖𝙧𝙩𝙚𝙙⚡")
    main()
