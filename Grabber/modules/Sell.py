...
async def sell(update, context):
    ...
    if not character:
        await update.message.reply_text('You dont have this character')
        return
    ...
    if character_to_sell:
        ...
        await update.message.reply_text(f"congratulations you sold a waifu {character_to_sell['name']} and got¸ {coin_value} Tokens⚡")
    else:
        await update.message.reply_text("CHARECTER NOT FOUND! 🙃...")
