...
from Grabber import application, top_global_groups_collection, pm_users, OWNER_ID 

async def broadcast(update: Update, context: CallbackContext) -> None:
    
    if update.effective_user.id != 6848223695:
...
application.add_handler(CommandHandler("fwd", broadcast, block=False))
